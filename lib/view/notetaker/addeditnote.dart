...
import 'package:mvvm_flutterapp/view/notetaker/widget/note_form_widget.dart';
...
class _AddEditNoteState extends State<AddEditNote> {
 ...
 Widget buildButton() {
  ...
  Future addNote() async{
   ...
   await MyNoteDataBase.instance.create(note);
  ...
  Future updateNote() async{
    ...
    await MyNoteDataBase.instance.update(note);
